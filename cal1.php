...
if (isset($_POST['Submit'])) {
    ...
    if ($InputUnit == "in") {
        $Convert = $InputValue / 3.28084 / 12;
        $ShowInputUnit = "Inches";
    } elseif ($InputUnit == "ft") {
        $Convert = $InputValue / 3.28084;
        $ShowInputUnit = "Feet";
    } elseif ($InputUnit == "yd") {
        $Convert = $InputValue / 3.28084 * 3;
        $ShowInputUnit = "Yards";
    } elseif ($InputUnit == "mi") {
        $Convert = $InputValue / 3.28084 * 5280;
        $ShowInputUnit = "Miles";
    }
...
<title>หน่วยวัดระบบอังกฤษ</title>
</head>
<body>
                ...
                <form method="post">
                    <div class="form-group">
                        ...
                        <select class="form-control " id="InputUnit" name="InputUnit">
                            <option>หน่วยวัดระบบอังกฤษ</option>
